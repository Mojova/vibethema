...
public class CharmsViewModelTest {
    ...
    void testFilterOptionsIncludeCraft() {
        ...
        assertTrue(viewModel.getFilterOptions().contains("Craft"), 
    ...
    void testFilterOptionsExcludeMartialArts() {
        ...
        assertFalse(viewModel.getFilterOptions().contains("Martial Arts"), 
            "Filter options should exclude 'Martial Arts' as it is handled by another filter type");
    }
}
