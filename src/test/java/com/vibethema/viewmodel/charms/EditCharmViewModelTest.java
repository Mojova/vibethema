...
class EditCharmViewModelTest {
    ...
    void setUp() {
        ...
        SolarCharm p1 = new SolarCharm(); p1.setId("p1"); p1.setName("Prereq 1");
        SolarCharm p2 = new SolarCharm(); p2.setId("p2"); p2.setName("Prereq 2");
    ...
    void testAbilityChangeRefreshesPrerequisites() {
        ...
        when(dataService.loadCharmsForAbility("Melee")).thenReturn(Collections.singletonList(meleePrereq));
