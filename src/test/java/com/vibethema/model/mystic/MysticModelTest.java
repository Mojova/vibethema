...
public class MysticModelTest {
    ...
    void testSorceryAvailability() {
        ...
        model.getUnlockedCharms()
                .add(
                        new PurchasedCharm(
                                "1",
                                SystemData.TERRESTRIAL_CIRCLE_SORCERY,
                                Ability.OCCULT.getDisplayName()));
        ...
        model.getUnlockedCharms()
                .add(
                        new PurchasedCharm(
                                "2",
                                SystemData.CELESTIAL_CIRCLE_SORCERY,
                                Ability.OCCULT.getDisplayName()));
    ...
    void testCharmTriggersUpdate() {
        ...
        model.getUnlockedCharms()
                .add(new PurchasedCharm("1", "Shadow Dancing", Ability.DODGE.getDisplayName()));
