...
public class ArmorTest {
    ...
    void testMortalArmorStats() {
        Armor light = new Armor("Padded", "Padded", Armor.ArmorType.MORTAL, Armor.ArmorWeight.LIGHT);
        ...
        Armor medium = new Armor("Breastplate", "Breastplate", Armor.ArmorType.MORTAL, Armor.ArmorWeight.MEDIUM);
    ...
    void testArtifactArmorStats() {
        ...
        Armor medium = new Armor("Lamellar", "Lamellar", Armor.ArmorType.ARTIFACT, Armor.ArmorWeight.MEDIUM);
        assertEquals(8, medium.getSoak());
        assertEquals(7, medium.getHardness());
        assertEquals(-1, medium.getMobilityPenalty());
        assertEquals(5, medium.getAttunement());

        Armor heavy = new Armor("ArtPlate", "ArtPlate", Armor.ArmorType.ARTIFACT, Armor.ArmorWeight.HEAVY);
