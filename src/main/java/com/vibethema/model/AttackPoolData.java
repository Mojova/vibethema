...
public class AttackPoolData {
    ...
    public AttackPoolData(Weapon weapon, String abilityName, String witheringPool, int decisivePool, int damage, int parry) {
        this.weapon = weapon;
    ...
    public String getWitheringPool() { return witheringPool; }
    public int getDecisivePool() { return decisivePool; }
