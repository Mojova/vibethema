...
/**
 * A lightweight wrapper around MVVMfx NotificationCenter to provide a consistent "Messenger"
 * interface for cross-viewModel communication.
 */
public class Messenger {

    private static final NotificationCenter center =
