...
public class UIUtils {
     ...
     */
    public static void showKeywordSelectionDialog(Window owner, CharmDataService dataService, List<String> current, java.util.function.Consumer<List<String>> onResult) {
