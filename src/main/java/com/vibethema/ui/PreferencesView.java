...
public class PreferencesView extends VBox implements JavaView<PreferencesViewModel>, Initializable {
    ...
    @InjectViewModel private PreferencesViewModel viewModel;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        paperSizeCombo
                .getItems()
                .addAll(
                        UserPreferencesService.PAPER_SIZE_A4,
                        UserPreferencesService.PAPER_SIZE_LETTER);
        ...
        themeCombo
                .getItems()
                .addAll(UserPreferencesService.THEME_DARK, UserPreferencesService.THEME_LIGHT);
