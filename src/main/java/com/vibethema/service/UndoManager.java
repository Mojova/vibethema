 ...
 * Uses snapshots of CharacterSaveState to perform Memento-based undo/redo.
 */
public class UndoManager {
    ...
    /**
     * Pops the last state for the specific context and returns it.
     * If contextId is null or empty, it treats it as a global undo.
     */
    ...
    /**
     * Returns true if the top of the undo stack matches the current context.
     * Use this for tab-scoped undo filtering.
     */
